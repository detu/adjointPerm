...
struct
{
  ...
  char     *type;       /* Loop or no loop */
} report_t;


void init_system        (system_t *sys, double dt, sparse_t *flux,
			 double *sources, double *volumes, double *u_old,
			 double mr, int maxit, double tolerance,double *work);

int solveScalar(int begin, int end, void *data, void* report);

int solveSystem(int begin, int end, void *data, void *report);

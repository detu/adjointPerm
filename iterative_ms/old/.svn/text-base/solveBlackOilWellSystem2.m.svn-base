function [resSol, wellSol] = solveBlackOilWellSystem2(resSol, wellSol,   ...
                                                     G, rock, S, fluid, ...
                                                     p0, dt, varargin)
%One iteration of succsubst algorithm on linearized Black Oil pressure system.
%
% SYNOPSIS:
%   [xr, xw] = solveBlackOilWellSystem2(xr, xw, G, rock, S, fluid, p0, dt)
%   [xr, xw] = solveBlackOilWellSystem2(xr, xw, G, rock, S, fluid, p0, dt, ...
%                                      'pn1', pv1, ...)
%
% REQUIRED PARAMETERS:

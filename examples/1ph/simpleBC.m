...
rock.perm = repmat([1000, 100, 10].* (1e-3*darcy()), [G.cells.num, 1]) ;
...
bc = fluxside([], G, 'LEFT',  1:ny, 1:nz, 1 / day());
...
resSol = solveIncompFlow(resSol, initWellSol([], 0.0), G, S, fluid, ...
...
clf
plotCellData(G, resSol.cellPressure / barsa(), 'EdgeColor', 'k');
...
% <font size="-1">
%   Last time modified:
%   $Id: simpleBC.m 1945 2009-03-31 09:22:39Z bska $
% </font>
% </html>

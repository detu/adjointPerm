...
%%
% More information bout the grid structure can be found in the
...
% restricted by setting all cells with enterpoint in (i,j)-coordinates
...
% <font size="-1">
%   Last time modified:
%   $Id: cornerPointModelExample.m 1947 2009-03-31 09:30:41Z bska $
% </font>
% </html>

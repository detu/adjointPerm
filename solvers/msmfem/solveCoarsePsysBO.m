function [xr, xw] = solveCoarsePsysBO(xr, xw, G, CG, p, rock, ...
...
%
   opt = struct('bc', [], 'src', [], 'wells', [], 'LinSolve', @mldivide);
   ...
   B  = (Lti * flx_bas).' * Psi;
   Vr = nonlin_term_res(xr.cellFlux, S.BI, Lt, zeta, omega, beta, ...
                        cellNo, ng, nKg);
   ...
   [Bw, Cw, Dw, Ctw, fw, hw] = well_contrib(opt.wells, xw, G, p, Lt, ...
                                            omega, zeta, Psi(:,wr), ...
                                            Phi_w, P, Vr, I);

function [simRes] = runScheduleMS(resSolInit, G, CG, SG, S, CS, p, W, rock, fluid, schedule, varargin)
% runSchedule -- Run simulation based on schedule.
%
% SYNOPSIS:
%   simRes = runScheduleMS(resSolInit, G, CG, S, CS, W, fluid, schedule, pn, pv, ...)
%
% DESCRIPTION:
%   
% PARAMETERS:
...
for k = 1 : numSteps
    ...
    [resSol, wellSol] = solveIncompFlowMS(resSol, wellSol, G, CG, p, S, CS, ...
                                          fluid, 'wells', W, ...
                                          'Solver', solver);
    ...
    resSol = implicitTransportCG(resSol, wellSol, G, SG, dt, rock, ...
                                 fluid, 'wells', W,                ...
                                 'nltol', 1.0e-7, 'lstrials', 50,  ...

function numGrad = computeNumericalGradientMS(simRes, G, CG, SG, S, CS, ...
                                              p, W, rock, fluid,        ...
                                              schedule, controls,       ...
                                              objectiveFunction)
...
for k = 1:dimU
    ...
    simRes    = runScheduleMS(simRes(1).resSol, G, CG, SG, S, CS, p, W, ...
                              rock, fluid, schedule, 'VerboseLevel', 0);
    obj       = objectiveFunction(G, S, W, rock, fluid, simRes);
    values(k) = obj.val;
end

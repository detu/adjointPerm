%----------------------------------------------------------------------------------
% DESCRIPTION:
%   Example input file for mrstEnKF. This example: top layer of a real-field 
%   ECLIPSE corner point grid (provided). Random Gaussian fields are
...
%----------------------------------------------------------------------------------
 ...
 sigma          = [ 20 * meter^3/day, ... % observation error standard deviations
                     5 * barsa(),     ... % for each type
                    0.05 ];
 range          = 0;                      % localization range: c(range) = 0, only
                                          % used with LEnKF

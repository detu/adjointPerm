function [adjRes] = solveDATransportSystem(G, S, W, rock, fluid, simRes, adjRes, obj, simResDer, varargin)
...
RHS     = -spdiags(simResDer(curStep).resSol.sw',numC, numC)*obj.partials(curStep).s2';
if curStep < numSteps
    numCF   = size(S.B, 1);
    numW    = numel(W);

...
% optimizeObjective -- Run whole optimization proccess
%
% SYNOPSIS:
...
%   - Tol           : tolerance in line search algorithm, proccess stops 
%                            when |du|/|u| < Tol (default 1e-6)
...
stepSize            = 1; %stepConst* .1/schedule(1).timeInterval(2);            

schedules{1} = schedule; 

while ( relNormGrad >= tol) && successLineSearch && iterationNum < 50
    ...
    [simRes, schedule, controls, lsData] = lineSearch( ...

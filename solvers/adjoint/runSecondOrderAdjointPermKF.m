function [secAdjRes] = runSecondOrderAdjointPermKF(simRes, adjRes, linSimRes, G, S, W, rock, fluid, schedule, controls, objectiveFunction, param, modelFunction, adData, varargin)

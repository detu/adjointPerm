function [Hv] = HessvecKF(dv, u, usr_par)
...
[G, S, W, rock, fluid, resSolInit, schedule, controls, objectiveFunction, modelFunction, g_mEns, g_m, asimStep, param, cov, priorPerm] = deal(usr_par{:});
...
secAdjRes = runSecondOrderAdjointPermKF(simRes, adjRes, linSimRes, G, S, W, rock, fluid, ...
                                  schedule, controls, objectiveFunction, param, modelFunction, ...
                                  adData, 'VerboseLevel', verboseLevel);
...
Hv        = compHvPermKF(param, G, S, W, rock, simRes, secAdjRes, schedule, controls, fluid, objectiveFunction, dv, adData); 

return
                              
%--------------------------------------------------------------------------

function Hv = compHvPermKF(param, G, S, W, rock, simRes, secAdjRes, schedule, controls, fluid, objectiveFunction, dv, adData)
...
[g_mEns, g_m, asimStep, cov, priorPerm] = deal(adData{:});
obj    = objectiveFunction(G, W, fluid, g_mEns, g_m, asimStep, cov, priorPerm, param, simRes);

function [xr, xw] = solveIncompFlow(xr, xw, g, s, fluid, varargin)
...
% $Date: 2009-10-20 12:55:32 +0200 (ti, 20 okt 2009) $
% $Revision: 3035 $
...
function [A, b, dF, dC] = build_system(xr, g, s, w, bc, src, fluid, opt)
   ...
   %    b{3} = h = [ hr   ;    hw ]  % VERTCAT
   %
   [Ar, br, dFr, dCr] = syscomp_res  (g, s, mob, omega, bc, src, opt);
   [Aw, bw, dFw, dCw] = syscomp_wells(g, w, mob, omega,          opt);
